                    ...
                    <?php if ($step == '1') { ?>
                        <div class="mounted-content-item show">
                            <div class="content-header">
                                multshop100%开源免费商用电商系统授权协议
                            </div>
                            <div class="content">
                                <h2>版权所有(c)2019-<?=date('Y')?>，multshop团队保留所有权利。</h2>
                                <p class="mt16">
                                    感谢你信任并选择multshop100%开源免费商用电商系统，multshop100%开源免费商用电商系统由广州好象科技有限公司（www.multshop.cn）原创研发并取得软件著作权，100%开放源码，无加密，自主可控，方便二次开发。</p>
                                <p class="mt6">为了正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：</p>
                                <h3 class="mt16">一、本授权协议适用且仅适用于multshop系列开源软件产品(以下简称multshop)任何版本，广州好象科技有限公司拥有本授权协议的最终解释权。</h3>
                                <h3 class="mt16">二、协议许可的权利</h3>
                                <p class="mt6">
                                    1．开源版本可以任意免费商用，可去除界面版权logo，不能去除代码版权。付费版本需要取得商业授权方可使用，否则会被视为盗版行为并承担相应法律责任。
                                </p>
                                <p class="mt6">
                                    2．请尊重multshop开源团队劳动成果，严禁使用本系统转手、转卖、倒卖或二次开发后转手、转卖、倒卖等商业行为。
                                </p>
                                <p class="mt6">
                                    3．任何企业和个人不允许对multshop程序代码以任何形式任何目的再发布。
                                </p>
                                <p class="mt6">
                                    4．你可以在协议规定的约束和限制范围内修改multshop系列开源软件产品或界面风格以适应你的网站要求。
                                </p>
                                <p class="mt6">
                                ...
                                <p class="mt6">
                                    3．未经官方许可，禁止在multshop开源商城的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。
                                </p>
                                <p class="mt6">
                                ...
                                <br><br>
                                <p class="mt6">
                                    multshop开源地址：https://gitee.com/multshop_gitee/multshop
                                </p>
                                <p class="mt6">
                                    multshop官方网站：https://www.multshop.cn
                                </p>
                                <p class="mt6">
                                    multshop知识社区：https://home.multshop.cn
                                </p>
                                <p class="mt6">
                                    -----------------------------------------------------
                                </p>
                        ...
                        <div class="mounted-content-item show">
                            <div class="mounted-env-container">
                                ...
                                <div class="mounted-tips mt16">
                                    系统要求multshop开源商城安装目录下的runtime和upload必须可写，才能使用multshop开源商城的所有功能。
                                </div>
                                <div class="mounted-item mt16">
                                    <div class="content-header">
                                        目录权限监测
                            ...
                            <?php if ($step == '5') { ?>
                                <div class="show" id="mounting-success">
                                    ...
                                    <div class="success-content">
                                        ...
                                        <div style="margin-top: 5px;font-size:14px;">版本号：2.5.5.20240430</div>
                                        <div class="tips">
